...
async def _mock_llm(prompt: str) -> str:
                    ...
                    "children": [
                        {
                            ...
                            "children": [
                                {
                                    "id": "leaf_1a",
                                    "name": "Top-Down Sizing",
                                    "description": "From total automotive market to L4+ sensor TAM",
                                    "children": [],
                                },
                                {
                                    "id": "leaf_1b",
                                    "name": "Bottom-Up Sizing",
                                    "description": "Per-vehicle sensor cost x projected L4+ fleet",
                                    "children": [],
                                },
                            ],
                        },
                        {
                            ...
                            "children": [
                                {
                                    "id": "leaf_2a",
                                    "name": "Vendor Landscape",
                                    "description": "LiDAR, radar, camera module suppliers",
                                    "children": [],
                                },
                                {
                                    "id": "leaf_2b",
                                    "name": "Technology Trajectories",
                                    "description": "Solid-state vs mechanical LiDAR",
                                    "children": [],
                                },
                            ],
                        },
                            ...
                            "children": [
                                {
                                    ...
                                    "description": "Key regulatory milestones by geography",
                                    "children": [],
                                },
                                {
                                    "id": "leaf_3b",
                                    "name": "OEM Adoption",
                                    "description": "Which OEMs are committed to L4+",
                                    "children": [],
                                },
                            ],
                        },
        ...
        return json.dumps(
            {
                ...
                "children": [
                    ...
                    },
                    {
                        "id": "fin_2",
                        "name": "Cost Structure",
                        "description": "Sensor BOM cost trajectory",
                        "children": [],
                    },
                ],
            }
                ...
                "children": [
                    {
                        ...
                        "description": "Production capacity and yield rates",
                        "children": [],
                    },
                    {
                        "id": "ops_2",
                        "name": "Supply Chain",
                        "description": "Key component sourcing and risks",
                        "children": [],
                    },
                ],
            }
                ...
                "children": [
                    {
                        ...
                        "description": "Key players and market share",
                        "children": [],
                    },
                    {
                        "id": "mkt_2",
                        "name": "Adoption Trajectory",
                        "description": "L4 deployment timeline and regional variation",
                        "children": [],
                    },
                ],
            }
    ...
    if "prioritizing research tasks" in p or (
        "decision_relevance" in p and "uncertainty_reduction" in p
    ):
                ...
                "scores": [
                    {
                        ...
                        "reasoning": "Core sizing question",
                    },
                    {
                        "branch_id": "leaf_1b",
                        ...
                        "reasoning": "Alternative estimation",
                    },
                    {
                        "branch_id": "leaf_2a",
                    ...
                    },
                    {
                        ...
                        "reasoning": "Regulatory gating",
                    },
                    {
                        "branch_id": "leaf_3b",
                        "decision_relevance": 0.75,
                        "uncertainty_reduction": 0.65,
                        "priority_score": 0.4875,
                        "reasoning": "OEM volume",
                    },
                ],
            }
        )
    ...
    if "fact-checking analyst" in p or "factscore" in p:
        ...
        return json.dumps(
            [
                {
                    "fact": "L4+ AV sensor TAM projected at $12-18B",
                    "status": "SUPPORTED",
                    "citation": "CIT-001",
                },
                {
                    "fact": "LiDAR costs declining at 20% CAGR",
                    "status": "SUPPORTED",
                    "citation": "CIT-002",
                },
            ]
            ...
            [
                {
                    ...
                    "confidence": 0.85,
                    "source_count": 4,
                    "reasoning": "Well-supported by multiple industry reports",
                },
                {
                    "index": 1,
                    "confidence": 0.72,
                    "source_count": 3,
                    "reasoning": "Solid-state transition introduces uncertainty",
                },
            ]
        )
