...
- the retrospectively normalized exact committed diff recorded in [candidate-4ff7e90-file-manifest.md](candidate-4ff7e90-file-manifest.md), derived from `git show --name-only 4ff7e90`
...
[candidate-4ff7e90-recovery-dirty-wip.patch](candidate-4ff7e90-recovery-dirty-wip.patch) is recovery evidence only.
