...
- `W2B-1`, `W3A-1`, `W3-1`, `W3B-1`, and `W4D-1` are now `CLEARED` in the authoritative retrospective review ledger.
- `W4-1` is now current `CONTINGENT` in that ledger and is the current retrospective stop sign.
- No later retrospective slice may now launch from the current review ledger.
- `W4B-1`, `W4B-2`, and `X-1` are blocked on retrospective audit authority until `W4-1` is later current `CLEARED`.
...
- Retrospective authority stop sign: `W4-1` is current `CONTINGENT` in the authoritative review ledger, so `W4B-1`, `W4B-2`, and `X-1` may not launch from the current review ledger.
...
- `W2B-1`, `W3A-1`, `W3-1`, `W3B-1`, and `W4D-1` are currently `CLEARED`.
- `W4-1` is currently `CONTINGENT` and is the current stop sign.
- No later retrospective slice may now launch from the current review ledger.
- `W4B-1`, `W4B-2`, and `X-1` are blocked on retrospective audit authority until `W4-1` is current `CLEARED`.
...
5. Treat `W4-1` as the current retrospective stop sign with current `CONTINGENT` status.
6. Do **not** launch `W4B-1`, `W4B-2`, or `X-1` until a later controller reconcile promotes `W4-1` to current `CLEARED`.
