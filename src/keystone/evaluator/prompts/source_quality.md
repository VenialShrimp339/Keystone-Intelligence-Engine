...
You are evaluating research output on the Source Quality dimension. Your task is to assess whether the sources cited are authoritative, diverse, and appropriate for the claims they support.
